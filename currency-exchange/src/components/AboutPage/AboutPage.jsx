export default function AboutPage () {
    return(
        ...
        <div className="bg-sky-100 rounded-lg">
            <h1 className="bg-blue-950 text-5xl font-serif text-white mt-12 p-4 font-bold rounded-lg">About the App</h1>
            <div className="font-serif text-black p-4 text-justify max-w-sm">
